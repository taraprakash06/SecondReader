...
export function marginCommentsLayout(variant: MarginCommentsLayoutVariant) {
  ...
  return {
    ...
    textCell: wide
      ? "border-zinc-200 bg-white px-4 py-5 sm:px-8 sm:py-6 lg:border-r lg:px-10 lg:pr-14"
      : "border-zinc-200 bg-white px-6 py-5 md:border-r md:pr-8",
    textInner: wide
      ? "max-w-none font-serif text-[16px] leading-[1.8] tracking-[0.01em] text-zinc-900"
      : "max-w-[52rem] font-serif text-[15px] leading-[1.75] tracking-[0.01em] text-zinc-900",
    sidebar: wide
      ? "flex flex-col gap-3 border-zinc-200 bg-[#eceff2] px-3 py-4 lg:border-0"
      : "flex flex-col gap-3 border-zinc-200 bg-[#eceff2] px-3 py-4 md:border-0",
